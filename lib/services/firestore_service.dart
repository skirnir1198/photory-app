...
class FirestoreService {
  ...
  Future<DocumentReference> addMilestone(
    String title,
    DateTime date, {
    String? imageUrl,
  }) async {
  ...
  Future<void> updateMilestoneData(
    String milestoneId,
    Map<String, dynamic> data,
  ) async {
    await _db.collection('milestones').doc(milestoneId).update(data);
  }

  Future<Milestone?> getMilestone(String milestoneId) async {
    final doc = await _db.collection('milestones').doc(milestoneId).get();
    if (doc.exists) {
