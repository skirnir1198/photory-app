...
class _AnniversaryScreenState extends State<AnniversaryScreen> {
  ...
  Future<void> _addAnniversary() async {
    ...
    final docRef = await _firestoreService.addMilestone(title, _selectedDate!, imageUrl: imageUrl);
          ...
          child: Column(
            children: <Widget>[
              ...
              ElevatedButton(
                ...
                child: Text(l10n.addAnniversary),
              ),
              const SizedBox(height: 20),
            ],
          ),
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  leading: milestone.imageUrl != null
                      ? Image.network(milestone.imageUrl!, width: 50, height: 50, fit: BoxFit.cover)
                      : null,
                  title: Text(
                    milestone.title,
                    style: const TextStyle(fontWeight: FontWeight.bold),
